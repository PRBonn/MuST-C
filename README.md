...
<details>
  ...
  1. Download QGIS [for Windows](https://ftp.osuosl.org/pub/osgeo/download/qgis/windows/QGIS-OSGeo4W-3.26.3-1.msi) or [Linux](https://download.qgis.org/downloads/qgis-3.26.3.tar.bz2). Note: we recommend using the older version of QGIS Buenos Aires due to current issues with PDAL.
